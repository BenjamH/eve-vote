// require these node modules.  morgan logs http requests and body-parser is middlewhere
...
// static css and js files from where node is beig processed
...
// on client-side, rendered HTML markup will get insert into the handler. on server a rendered HTML markup is sent to index.html template where insert into <div id="app>{{html|safe}}</div> by Swig templating engine.
